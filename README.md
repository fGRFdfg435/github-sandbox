...
A GitHub Actions workflow,,, that lets youd download files into your repository just by writing a special commit message — no terminal ffor command line needed.
